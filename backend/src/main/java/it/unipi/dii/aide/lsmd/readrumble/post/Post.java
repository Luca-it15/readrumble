...
public class Post {
    ...
    public Post(int _id, int book_id, int rating, String review_text, Date date, String book_title, String username, List<String> tags, int bookmark, int pages_read) {
        this._id = _id;
