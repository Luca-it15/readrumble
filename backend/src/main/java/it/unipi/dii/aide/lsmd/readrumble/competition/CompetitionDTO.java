...
public class CompetitionDTO {
    ...
    public CompetitionDTO(String name, String tag, LocalDate start_date, LocalDate end_date, ArrayList rank) {
        ...
        this.rank = rank;
        this.isEnded = end_date.isBefore(LocalDate.now());
    }
    ...
    public CompetitionDTO(Document doc) {
        ...
        try {
            ...
            Date start_date = doc.get("start_date") instanceof String ?
                    sdf.parse((String) doc.get("start_date"))
                    :
                    (Date) doc.get("start_date");

            Date end_date = doc.get("end_date") instanceof String ?
                    sdf.parse((String) doc.get("end_date"))
                    :
                    (Date) doc.get("end_date");
        ...
        this.isEnded = this.end_date.isBefore(LocalDate.now());
    }
